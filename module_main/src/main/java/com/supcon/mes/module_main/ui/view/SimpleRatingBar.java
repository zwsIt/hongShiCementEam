...
public class SimpleRatingBar extends View {
  ...
  private void initView() {
    ...
    int c1 = Color.parseColor("#FF3D00");
    int c2 = Color.parseColor("#FFB000");
  ...
  private void parseAttrs(AttributeSet attrs) {
    ...
    borderColor = arr.getColor(R.styleable.SimpleRatingBar_srb_borderColor, getResources().getColor(R.color.color_ffa000));
  ...
  private void drawStar(Canvas canvas, float x, float y, float filled, Gravity gravity) {
    ...
    if (gravity == Gravity.Left) {
      LinearGradient linearGradient = new LinearGradient(x, y,
              x + fill + currentStarSize *0.02f, y + currentStarSize
              ,colors, null, LinearGradient.TileMode.CLAMP);
      paintStarFill.setShader(linearGradient);
      // color star fill
      ...
      LinearGradient linearGradient = new LinearGradient(x + currentStarSize - (fill+ currentStarSize *0.02f), y,
              x + currentStarSize,y + currentStarSize
              ,colors, null, LinearGradient.TileMode.CLAMP);
      paintStarFill.setShader(linearGradient);
      // color star fill
