 ...
 * 设备区域位置选择
 */
@Router(value = Constant.Router.EAM_AREA_TREE_SELECT)
@Presenter(EamAreaTreeSelectPresenter.class)
public class EamAreaTreeSelectActivity extends BaseRefreshRecyclerActivity<ICustomTreeView<Area>> implements EamAreaTreeSelectContract.View {
    @BindByTag("leftBtn")
    ImageButton leftBtn;
    @BindByTag("titleText")
    TextView titleText;
