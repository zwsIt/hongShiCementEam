...
/**
 * ClassName
 * Created by zhangwenshuai1 on 2020/7/11
 * Email zhangwenshuai1@supcon.com
 * Desc 角标应用工具类
 */
public class BadgeUtil {
    private static int notificationId = 0;
    public static boolean setBadgeConunt(Context context,int count,Notification notification){
...
//                    Toast.makeText(context, "请切到后台，3秒后会收到通知", Toast.LENGTH_SHORT).show();
    ...
    public static boolean setNotificationBadge(int count, Context context) {
        ...
        Notification notification = new NotificationCompat.Builder(context, "badge")
                .setContentTitle("应用消息提醒")
                .setContentText("您有" + count + "条未读消息")
                .setLargeIcon(BitmapFactory.decodeResource(context.getResources(), R.drawable.ic_app_launcher_hongshi))
