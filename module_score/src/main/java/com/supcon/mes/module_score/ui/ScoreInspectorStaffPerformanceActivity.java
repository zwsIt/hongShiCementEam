...
public class ScoreInspectorStaffPerformanceActivity extends BaseRefreshRecyclerActivity<ScoreStaffPerformanceEntity> implements ScoreInspectorStaffPerformanceContract.View, ScoreStaffSubmitContract.View {
    @BindByTag("leftBtn")
    ImageButton leftBtn;
    @BindByTag("titleText")
    TextView titleText;
    ...
    protected void initListener() {
        ...
        refreshListController.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                presenterRouter.create(ScoreInspectorStaffPerformanceAPI.class).getInspectorStaffScore(staffId, scoreStaffEntity.id);
//
//                presenterRouter.create(ScoreInspectorStaffPerformanceAPI.class).getDutyEam(staffId, ScoreConstant.ScoreType.INSPECTION_STAFF);
        ...
        scoreStaff.setOnChildViewClickListener(new OnChildViewClickListener() {
            ...
            public void onChildViewClick(View childView, int action, Object obj) {
                ...
                IntentRouter.go(ScoreInspectorStaffPerformanceActivity.this, Constant.Router.CONTACT_SELECT, bundle);
            }
        });
