...
import com.supcon.mes.module_hs_tsd.constant.OperateItemOnEnum;
...
public class OperateItemOnController extends BaseViewController implements OperateItemContract.View {
    ...
    public OperateItemOnController(View rootView) {
        super(rootView);
    }
...
//        Glide.with(context).asGif().load(R.drawable.preloader_1).apply(RequestOptions.diskCacheStrategyOf(DiskCacheStrategy.ALL)).into(customListWidgetEdit);
        String url = "/BEAMEle/onOrOff/onoroff/data-dg1545369078671.action?datagridCode=BEAMEle_1.0.0_onOrOff_eleOnEditdg1545369078671&rt=json";
    ...
    private void initOperateItemEntityList() {
        ...
        for (OperateItemOnEnum detail : OperateItemOnEnum.values()){
