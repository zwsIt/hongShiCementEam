...
public interface ElectricityConstant {
    ...
    interface HeaderData {
        String HEADER_DATA_INCLUDES = "id,createStaffId,createTime,version,deploymentId,tableInfoId,tableNo,remark,applyStaff.id,applyStaff.code,applyStaff.name," +
                ...
                "applyCurrentDept.id,applyCurrentDept.name,applyCurrentDept.code,eamID.id,eamID.code,eamID.eamAssetcode,eamID.name,workRecordId,workRecordTableno,applyDate,operateDate," +
                ...
                "securityStaff.id,securityStaff.name,securityStaff.code,electrician.id,electrician.name,electrician.code,chargeStaff.id,chargeStaff.name,chargeStaff.code";
    }
