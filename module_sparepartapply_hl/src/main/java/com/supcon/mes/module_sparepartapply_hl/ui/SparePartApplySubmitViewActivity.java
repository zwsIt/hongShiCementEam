...
/**
 * @description SparePartApplySubmitViewActivity 备件领用申请审核编辑
...
public class SparePartApplySubmitViewActivity extends BaseRefreshActivity implements SparePartApplyContract.View {
    ...
    protected void onInit() {
        ...
        sparePartApplyDetailController.setEditable(true,false).setPTUrl("/BEAM2/sparePart/apply/data-dg1535960092493.action");
    }
    ...
    private void submit(List<WorkFlowEntity> workFlowEntities) {
        ...
        map.put("viewCode", "BEAM2_1.0.0_sparePart_sparePartSubmitEdit");
        map.put("modelName", "Apply");
        map.put("datagridKey", "BEAM2_sparePart_apply_sparePartEdit_datagrids");
        map.put("viewselect", "sparePartSubmitEdit");
        map.put("id", tableId);
...
//        map.put("taskDescription", "BEAM2_1.0.0.sparePartApply.task340");
        map.put("activityName", getController(LinkController.class).getLinkEntities().get(0).source);
        ...
        map = SparePartReceiveMapManager.dgDeleted(map,dgDeletedIds_sparePartApplyDetail,"dg1535960092493");
        map.put("dg1535960092493ModelCode", "BEAM2_1.0.0_sparePart_SparePartApply");
        map.put("dg1535960092493ListJson", list.toString());
        map.put("dgLists['dg1535960092493']", list.toString());
