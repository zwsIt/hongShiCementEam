...
public class OLXJPathListAdapter extends BaseListDataRecyclerViewAdapter<XJPathEntity> {

//    private SparseArray<Boolean> expandList = new SparseArray<>();
    private int expandPosition = -1;
    private SparseArray<Boolean> startList = new SparseArray<>();

    public OLXJPathListAdapter(Context context) {
        super(context);
    }
...
//            mOLXJAreaListAdapter.addList(areas);
            mOLXJAreaListAdapter.notifyDataSetChanged();
