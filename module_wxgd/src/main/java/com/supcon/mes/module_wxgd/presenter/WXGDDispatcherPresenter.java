...
public class WXGDDispatcherPresenter extends WXGDDispatcherContract.Presenter {
    ...
    @Override
    public void translateRepair(long workRecordId, String repairType) {
        mCompositeSubscription.add(
                HttpClient.translateRepair(workRecordId, repairType)
                        .onErrorReturn(new Function<Throwable, ResultEntity>() {
                            ...
                            public ResultEntity apply(Throwable throwable) throws Exception {
                                ...
                                resultEntity.errMsg = HttpErrorReturnUtil.getErrorInfo(throwable);
                                return resultEntity;
                            }
                        })
