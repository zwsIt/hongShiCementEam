 ...
 * ------------- Description -------------
 */
public class SparePartsConsumeLedgerPresenter extends SparePartsConsumeLedgerContract.Presenter {
    @Override
    public void productConsumeList(Map<String, Object> params, int page) {
        ...
        mCompositeSubscription.add(HttpClient.productConsumeList(fastQueryCond, pageQueryParams)
                .onErrorReturn(throwable -> {
                    ...
                    public void accept(CommonBAPListEntity<SparePartsConsumeEntity> sparePartsEntity) throws Exception {
                        if (TextUtils.isEmpty(sparePartsEntity.errMsg)) {
                            getView().productConsumeListSuccess(sparePartsEntity);
                        } else {
                            getView().productConsumeListFailed(sparePartsEntity.errMsg);
                        }
                    }
                }));
    }
