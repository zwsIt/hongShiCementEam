...
public class StopPolicePresenter extends StopPoliceContract.Presenter {
    ...
    public void runningGatherList(Map<String, Object> params, int page) {
        ...
        //特殊处理：需要放入联合查询中的联合查询
        if (params.containsKey(Constant.BAPQuery.EAMTYPE_NAME)){
            for (BaseSubcondEntity entity:fastQuery.subconds){
                if (entity instanceof JoinSubcondEntity){  // 联合查询
                    JoinSubcondEntity joinSubcondEntity = (JoinSubcondEntity) entity;
